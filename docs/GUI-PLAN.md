...
| 2.57 | What a search can ask for, worked out and shown where it is chosen: a window no larger than the model can read in one request, and no more clips than the window can hold at their shortest | `[ ]` |
