...
.PHONY: all run app icon motion ffmpeg llama tools-archive notices deps tools-beside test unit fuzz interface check tools models clean help toolchain modules $(PROGRAMS)
